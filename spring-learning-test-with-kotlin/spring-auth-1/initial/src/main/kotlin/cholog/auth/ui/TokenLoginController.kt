...
class TokenLoginController(
    ...
    fun tokenLogin(@RequestBody tokenRequest: TokenRequest): ResponseEntity<TokenResponse> {
        // TODO: Receive a TokenRequest containing email and password as a method parameters (Hint: Use @RequestBody)
    ...
    fun findMyInfo(request: HttpServletRequest): ResponseEntity<MemberResponse> {
        // TODO: Extract the token from the authorization header (Hint: Use authorizationExtractor)
